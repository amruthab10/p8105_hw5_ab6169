...
I observed that as the effect size (true mean) increases, the power of the test also increases. I see that when the true mean is is close to 0, the power is low. As the effect size gets larger, there is higher statistical power. This basically means that the probability of rejecting the null rises sharply. 
